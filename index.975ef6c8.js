...
var _switchTheme = require("./js/switch-theme");
var _extraBlockSlider = require("./js/extra-block-slider");
var _modalWindow = require("./js/modal-window");
var _burgerMenu = require("./js/burger-menu");
var _renderCategoriesList = require("./js/render-categories-list");
var _renderCategoriesBooks = require("./js/render-categories-books");
var _booksAction = require("./js/books-action");
var _chooseCategory = require("./js/choose-category");
var _renderCategoryBooks = require("./js/render-category-books");
var _shoppingList = require("./js/shopping-list");
var _colorSwithcer = require("./js/color-swithcer");

},{"./js/switch-theme":"8ea4I","./js/extra-block-slider":"iKyTx","./js/modal-window":"bg8pZ","./js/burger-menu":"egJfa","./js/render-categories-list":"bBCra","./js/render-categories-books":"esDMw","./js/books-action":"gsCQ3","./js/choose-category":"dg41E","./js/render-category-books":"eN6lp","./js/shopping-list":"23YiB","./js/color-swithcer":"65EWk"}],"8ea4I":[function(require,module,exports) {
...
function switchTheme() {
    if ((0, _shoppingList.shopping_info).theme === "light") renderTheme("light");
    else renderTheme("dark");
}
function switchCheck() {
    if (this.getAttribute("data-checked") === "true") (0, _shoppingList.shopping_info).theme = "light";
    else (0, _shoppingList.shopping_info).theme = "dark";
    (0, _shoppingList.saveShoppingList)((0, _shoppingList.shopping_info));
    switchTheme();
}
function loadSwitchButton() {
    if ((0, _shoppingList.shopping_info).theme === "light") {
...
},{"./shopping-list":"23YiB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"23YiB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "shopping_info", ()=>shopping_info);
parcelHelpers.export(exports, "saveShoppingList", ()=>saveShoppingList);
parcelHelpers.export(exports, "removeShoppingListBoock", ()=>removeShoppingListBoock);
// додаємо в localStorage
parcelHelpers.export(exports, "addBook", ()=>addBook);
const shopping_info = JSON.parse(localStorage.getItem("client-info")) || {
    theme: "light",
    shopping_list: {}
};
function saveShoppingList(listBooks) {
    console.log("saveShoppingList", listBooks);
    localStorage.setItem("client-info", JSON.stringify(listBooks));
}
function removeShoppingListBoock(idBoock) {
    for(const key in shopping_info.shopping_list)if (key === idBoock) delete shopping_info.shopping_list[key];
    saveShoppingList(shopping_info);
}
function addBook(key_new, book) {
...
},{}],"iKyTx":[function(require,module,exports) {
// Слайдер для Support Ukrain
var _supportData = require("./support-data");
const supportEl = document.querySelector("ul.support-list");
const supportUkraineMarkup = (0, _supportData.support_array).map(({ title , url , img , id  }, index)=>{
    return `<li class="support-item"><span class="item-number">${addNum(index + 1)}</span>
...
function onScrollBtn() {
    if (isScrolledToEnd) supportEl.scrollTo({
        top: 0,
        behavior: "smooth"
    });
    else supportEl.scrollTo({
        top: supportEl.scrollHeight,
        behavior: "smooth"
    });
...
},{"./support-data":"12YXB"}],"12YXB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "support_array", ()=>support_array);
const support_array = [
    {
    ...
    },
    {
        ...
        img: require("../images/extra-block/hope.png"),
        id: "02"
    },
    {
        title: "International Medical Corps",
        url: "https://internationalmedicalcorps.org/country/ukraine/",
        img: require("../images/extra-block/medical.png"),
        id: "03"
    },
    {
        title: "RAZOM",
        url: "https://www.razomforukraine.org/",
        img: require("../images/extra-block/razom.png"),
        id: "04"
    },
    {
        title: "Action against hunger",
        url: "https://www.actionagainsthunger.org/location/europe/ukraine/",
        img: require("../images/extra-block/action.png"),
        id: "05"
    },
    {
        title: "Serhiy Prytula Charity Foundation",
        url: "https://prytulafoundation.org/en",
        img: require("../images/extra-block/serhiy.png"),
        id: "06"
    },
    {
        title: "UNITED24",
...
},{"../images/extra-block/saveCh.png":"1fvuq","../images/extra-block/hope.png":"1NJaQ","../images/extra-block/medical.png":"flZPz","../images/extra-block/razom.png":"bcCCV","../images/extra-block/action.png":"lHJoV","../images/extra-block/serhiy.png":"bLzfa","../images/extra-block/united.png":"dXklI","../images/extra-block/sans.png":"4CyTk","../images/extra-block/vision.png":"ggoKp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1fvuq":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "saveCh.7fa8f133.png" + "?" + Date.now();
...
},{}],"1NJaQ":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "hope.09fcbd73.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"flZPz":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "medical.3f709fb0.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"bcCCV":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "razom.15eb9ecf.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"lHJoV":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "action.65c5565e.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"bLzfa":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "serhiy.9000f9d1.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"dXklI":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "united.55f83227.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"4CyTk":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "sans.81d4d48f.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"ggoKp":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "vision.47c10699.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"bg8pZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _booksAction = require("./books-action");
var _shoppingList = require("./shopping-list");
var _fetchFunc = require("./fetch-func");
function modalWindow() {
    ...
    cardList.addEventListener("click", (e)=>{
        ...
        if (linkId && linkId.hasAttribute("data-id")) {
            ...
            console.log(dataId);
            (0, _fetchFunc.fetchBook)(dataId).then((data)=>{
                console.log(data);
                ...
                <div class="wrap">
                    ...
                    <div class="about-book">
                        ...
                        <ul class="shops-list global-list">
                            <li class="shop-list-item"><a class="shop-link global-link" href="${buy_links[0].url}."><img class="shop-icon" src=${require("../images/modal-window-book/icons/amazon_bk.png")} alt="amazon" width="62" height="19"/></a></li>
                            <li class="shop-list-item"><a class="shop-link global-link" href="${buy_links[1].url}"><img class="shop-icon" src=${require("../images/modal-window-book/icons/open-book_bk.png")} alt="apple-book" width="32" height="32"/></a></li>
        ...
        function funcBtn(id, book) {
            ...
            addRemBtn.addEventListener("click", function() {
                if (!(0, _shoppingList.shopping_info).shopping_list[id]) {
                    console.log("Add");
                    (0, _booksAction.addBook)(id, book);
                    console.log("funcBtn");
                    (0, _shoppingList.shopping_info).shopping_list;
                    addRemBtn.textContent = "REMOVE FROM THE SHOPING LIST";
                    congratulations.classList.remove("no-content");
                } else {
                    console.log("Add");
                    (0, _booksAction.removeBook)(id);
                    addRemBtn.textContent = "ADD TO SHOPING LIST";
...
},{"./books-action":"gsCQ3","./shopping-list":"23YiB","./fetch-func":"i4UGa","../images/modal-window-book/icons/amazon_bk.png":"7WNkv","../images/modal-window-book/icons/open-book_bk.png":"aMVxt","../images/modal-window-book/icons/book-shop_bk.png":"2bBRC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gsCQ3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addBook", ()=>addBook);
...
var _shoppingList = require("./shopping-list");
function addBook(key_new, book) {
    (0, _shoppingList.shopping_info).shopping_list[key_new] = book;
    (0, _shoppingList.saveShoppingList)((0, _shoppingList.shopping_info));
}
function removeBook(idBook) {
    for(const key in (0, _shoppingList.shopping_info).shopping_list)if (key === idBook) delete (0, _shoppingList.shopping_info).shopping_list[key];
    (0, _shoppingList.saveShoppingList)((0, _shoppingList.shopping_info));
}

},{"./shopping-list":"23YiB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i4UGa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchAllCategories", ()=>fetchAllCategories);
parcelHelpers.export(exports, "fetchTopBooks", ()=>fetchTopBooks);
//REST API: books-backend.p.goit.global/books/bookId
parcelHelpers.export(exports, "fetchExactBook", ()=>fetchExactBook);
//REST API: https://books-backend.p.goit.global/books/category?category=$
parcelHelpers.export(exports, "fetchBooksByExactCategory", ()=>fetchBooksByExactCategory);
...
async function fetchTopBooks() {
    try {
        return await (0, _axiosDefault.default).get("", {
            baseURL: "https://books-backend.p.goit.global/books/top-books"
        });
    } catch (error) {
        (0, _notiflixDefault.default).Notify.failure("Sorry, something is wrong. Please try later.");
        console.error(error);
    }
}
function fetchExactBook() {}
async function fetchBooksByExactCategory(item) {
    try {
        const response = await (0, _axiosDefault.default)(`${BASE_URL}/books/category?category=${item}`);
        return response;
    } catch (error) {
        (0, _notiflixDefault.default).Notify.failure("Sorry, something is wrong. Please try later.");
    }
}
async function fetchBook(dataId) {
    try {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}/books/${dataId}`);
...
},{}],"7WNkv":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "amazon_bk.19b0710c.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"aMVxt":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "open-book_bk.58d5cfa3.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"2bBRC":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "book-shop_bk.782906c8.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"egJfa":[function(require,module,exports) {
...
(()=>{
    ...
    const toggleMenu = ()=>{
        ...
        isMenuOpen ? document.querySelector("body").style.overflow = "auto" : document.querySelector("body").style.overflow = "hidden";
    };
...
if (shoppingPage) linksMenu[1].classList.toggle("colored-link-menu");
else linksMenu[0].classList.toggle("colored-link-menu");

},{}],"bBCra":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
// Логіка, яка рендерить список категорій
// Визиваеться одразу в index.js
var _fetchFunc = require("./fetch-func");
var _shoppingList = require("./shopping-list");
var _switchTheme = require("./switch-theme");
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
const categoryList = document.querySelector(".category-list");
const loadCategory = document.querySelector(".load");
const loader = document.querySelector(".loader");
(0, _fetchFunc.fetchAllCategories)().then((data)=>{
    ...
    lis.forEach((e1)=>{
        e1.addEventListener("click", activatedCategory);
        function activatedCategory() {
            lis.forEach((e)=>e.classList.remove("active"));
            this.classList.add("active");
        }
    });
    (0, _shoppingList.shopping_info).theme === "light" ? (0, _switchTheme.renderTheme)("light") : (0, _switchTheme.renderTheme)("dark");
    loadCategory.classList.add("unvisible");
}).catch((error)=>{
    console.log(error);
});

},{"./fetch-func":"i4UGa","./shopping-list":"23YiB","./switch-theme":"8ea4I","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"esDMw":[function(require,module,exports) {
...
var _fetchFunc = require("./fetch-func"); // import { renderCategoryBooks, renderTopBooks } from './render-category-books';
 // одразу рендеремо секцію топ
 // renderTopBooks();

},{"./fetch-func":"i4UGa"}],"dg41E":[function(require,module,exports) {
// логіка, коли вибираешь категорію
var _fetchFunc = require("./fetch-func");

},{"./fetch-func":"i4UGa"}],"eN6lp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderCategoryBooks", ()=>renderCategoryBooks);
...
async function renderCategoryBooks(event) {
    ...
    if (item === itemFirst) {
        bookThumb.innerHTML = "";
        (0, _fetchFunc.fetchTopBooks)().then(renderTopBooks);
        const headingMarkup = "Best Sellers Books";
        const startHeading = headingMarkup.split(" ").splice(0, headingMarkup.split(" ").length - 1).join(" ");
        const endHeading = headingMarkup.split(" ")[headingMarkup.split(" ").length - 1];
        headingEl.innerHTML = `${startHeading} <span class="colored-heading">${endHeading}</span>`;
    } else {
        const startHeading = item.split(" ").splice(0, item.split(" ").length - 1).join(" ");
        ...
        const data = await (0, _fetchFunc.fetchBooksByExactCategory)(item);
        loader.classList.add("is-hidden");
...
function createMarkupBook({ data  }) {
    bookThumb.innerHTML = "";
    const markup = data.map(({ list_name , book_image ="https://bookcart.azurewebsites.net/Upload/Default_image.jpg" , title ="title not available" , author ="anonymous" , description , _id ,  })=>{
        return `
...
function renderTopBooks({ data  }) {
    if (data.length == 0) noBooksEl.classList.remove("is-hidden");
    else {
        const markupCategory = data.map(({ list_name , books  })=>{
            const markup = books.map(({ list_name , book_image ="https://bookcart.azurewebsites.net/Upload/Default_image.jpg" , title ="title not available" , author ="anonymous" , description , _id ,  })=>{
                return `
          <li class="flex-container-item">
            <a href=# class="global-link" data-id="${_id}">
              <div class="tb-book-card">
...
async function onSeeMoreClick(event) {
    if (event.target.matches("button")) {
        ...
        const data = await (0, _fetchFunc.fetchBooksByExactCategory)(bookTitle);
...
},{"./fetch-func":"i4UGa","./modal-window":"bg8pZ","./shopping-list":"23YiB","./switch-theme":"8ea4I","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"65EWk":[function(require,module,exports) {
...
function toggleLogoImage() {
    ...
    logoImages.forEach((logoImage)=>{
        if (logoImage.classList.contains("light-theme")) logoImage.src = require("/src/images/header/logo-light.png");
        else if (logoImage.classList.contains("dark-theme")) logoImage.src = require("/src/images/header/logo-dark.png");
    });
}
...
},{"/src/images/header/logo-light.png":"2B6PE","/src/images/header/logo-dark.png":"9Xfoo"}],"2B6PE":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "logo-light.0235434a.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"9Xfoo":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "logo-dark.f5a1e6d2.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
