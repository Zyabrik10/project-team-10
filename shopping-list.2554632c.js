import"./project-team-10.1fe5741d.js";var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},o={},r=e.parcelRequire0688;null==r&&((r=function(e){if(e in t)return t[e].exports;if(e in o){var r=o[e];delete o[e];var a={id:e,exports:{}};return t[e]=a,r.call(a.exports,a,a.exports),a.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){o[e]=t},e.parcelRequire0688=r),r.register;var a=r("je8ct"),s=r("2GpPp"),c=r("l7N25");(async()=>{let e=document.querySelector(".books"),t=document.querySelector(".no-books"),o=(0,s.localStorageGetItem)("user-fav-books"),r="";for(let e of(0===o.length?t.style.display="block":t.style.display="none",o)){let{title:t,author:o,description:s,buy_links:c,book_image:l,list_name:i}=await (0,a.getBookById)(e);r+=`
        <li data-id='${e}'>
<div class="shop-card">
    <img class="shop_card-img" src="${l}" alt="${t}" />
    <div class="shop-card-book-info">
        <div class='shop-card-book-header'>
          ...
          <button class="shop-card-remove-book-button" data-id="${e}">
<svg width="28px" height="28px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="fill: none;">
  ...
  <path d="M6.5 6C6.55588 6 6.58382 6 6.60915 5.99936C7.43259 5.97849 8.15902 5.45491 8.43922 4.68032C8.44784 4.65649 8.45667 4.62999 8.47434 4.57697L8.57143 4.28571C8.65431 4.03708 8.69575 3.91276 8.75071 3.8072C8.97001 3.38607 9.37574 3.09364 9.84461 3.01877C9.96213 3 10.0932 3 10.3553 3H13.6447C13.9068 3 14.0379 3 14.1554 3.01877C14.6243 3.09364 15.03 3.38607 15.2493 3.8072C15.3043 3.91276 15.3457 4.03708 15.4286 4.28571L15.5257 4.57697C15.5433 4.62992 15.5522 4.65651 15.5608 4.68032C15.841 5.45491 16.5674 5.97849 17.3909 5.99936C17.4162 6 17.4441 6 17.5 6" stroke="#fff" stroke-width="1.5" />
    ...
    </div></li>`}let l=`<ul>${r}</ul>`;e.innerHTML="",e.insertAdjacentHTML("afterbegin",l),e.addEventListener("click",(0,c.default)(async({target:e})=>{if("BUTTON"!==e.tagName)return;let o=e.dataset.id;await (0,s.removeFavBook)(o),0===(0,s.localStorageGetItem)("user-fav-books").length?t.style.display="block":t.style.display="none",document.querySelector(`li[data-id='${o}']`).remove(),document.querySelectorAll(".header-shopping-cart-number").forEach(e=>e.innerText=(0,s.localStorageGetItem)("user-fav-books").length)}))})();
//# sourceMappingURL=shopping-list.2554632c.js.map
