...
})({"yPxfL":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "a2286cceb8551ebe";
"use strict";
...
},{}],"kCiXf":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _apis = require("./apis");
var _utils = require("./utils");
var _utilsCatchError = require("./utils/utils.catchError");
var _utilsCatchErrorDefault = parcelHelpers.interopDefault(_utilsCatchError);
(async ()=>{
    const booksElement = document.querySelector(".books");
    const noBooksElement = document.querySelector(".no-books");
    const favBooks = (0, _utils.localStorageGetItem)("user-fav-books");
    let bookComponents = "";
    if (favBooks.length === 0) noBooksElement.style.display = "block";
    else noBooksElement.style.display = "none";
    for (const element of favBooks){
        const bookId = element;
        const { title, author, description, buy_links, book_image, list_name } = await (0, _apis.getBookById)(bookId);
        bookComponents += `
        <li data-id='${bookId}'>
<div class="shop-card">
...
<svg width="28px" height="28px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="fill: none;">
  ...
  <path d="M6.5 6C6.55588 6 6.58382 6 6.60915 5.99936C7.43259 5.97849 8.15902 5.45491 8.43922 4.68032C8.44784 4.65649 8.45667 4.62999 8.47434 4.57697L8.57143 4.28571C8.65431 4.03708 8.69575 3.91276 8.75071 3.8072C8.97001 3.38607 9.37574 3.09364 9.84461 3.01877C9.96213 3 10.0932 3 10.3553 3H13.6447C13.9068 3 14.0379 3 14.1554 3.01877C14.6243 3.09364 15.03 3.38607 15.2493 3.8072C15.3043 3.91276 15.3457 4.03708 15.4286 4.28571L15.5257 4.57697C15.5433 4.62992 15.5522 4.65651 15.5608 4.68032C15.841 5.45491 16.5674 5.97849 17.3909 5.99936C17.4162 6 17.4441 6 17.5 6" stroke="#fff" stroke-width="1.5" />
    ...
    booksElement.addEventListener("click", (0, _utilsCatchErrorDefault.default)(async ({ target })=>{
        if (target.tagName !== "BUTTON") return;
        const bookId = target.dataset.id;
        await (0, _utils.removeFavBook)(bookId);
        if ((0, _utils.localStorageGetItem)('user-fav-books').length === 0) noBooksElement.style.display = "block";
        else noBooksElement.style.display = "none";
        document.querySelector(`li[data-id='${bookId}']`).remove();
        document.querySelectorAll(`.header-shopping-cart-number`).forEach((e)=>e.innerText = (0, _utils.localStorageGetItem)("user-fav-books").length);
    }));
})();

},{"./apis":"2Z75C","./utils":"gHQmv","./utils/utils.catchError":"9xBTK","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["yPxfL","kCiXf"], "kCiXf", "parcelRequire0688", {})

//# sourceMappingURL=shopping-list.b8551ebe.js.map
