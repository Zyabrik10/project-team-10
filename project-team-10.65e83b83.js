...
})({"5GXJg":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "a982e18865e83b83";
"use strict";
...
},{}],"1qSGm":[function(require,module,exports,__globalThis) {
var _firebase = require("./firebase");
var _classes = require("./classes");
var _utils = require("./utils");
(async ()=>{
    const registrationModal = new (0, _classes.ModalWindow)("registration-modal");
    ...
    (0, _firebase.onUserLoggedIn)(async (loggedInUser)=>{
        if (loggedInUser) {
            const user = await (0, _firebase.getUserById)(loggedInUser.uid);
            headerShoppingCartNumber.forEach((e)=>e.innerText = user.favBooks.length);
            registrationModal.hideModalWindow();
            (0, _utils.localStorageSetItem)('user-id', loggedInUser.uid);
            (0, _utils.localStorageSetItem)('user-fav-books', user.favBooks);
            headerAuthButtons.forEach((e)=>e.classList.add('active'));
        } else {
            headerAuthButtons.forEach((e)=>e.classList.remove('active'));
            (0, _utils.localStorageSetItem)('user-id', '');
            (0, _utils.localStorageSetItem)('user-fav-books', '');
    ...
    signinForm.addEventListener('submit', async (e)=>{
        ...
        await (0, _firebase.signup)(newUserBuffer);
    });
    loginForm.addEventListener('submit', async (e)=>{
        ...
        await (0, _firebase.signin)(newUserBuffer);
    });
...
},{"./firebase":"1gcbW","./classes":"8hMvV","./utils":"gHQmv"}],"8hMvV":[function(require,module,exports,__globalThis) {
...
},{"./ModalWindow":"6bTdx","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6bTdx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class ModalWindow {
    constructor(modalId){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5GXJg","1qSGm"], "1qSGm", "parcelRequire0688", {})

//# sourceMappingURL=project-team-10.65e83b83.js.map
