...
})({"kIEhV":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "1a986116dce11834";
...
},{}],"dT0E2":[function(require,module,exports) {
...
var _renderShoppingList = require("./js/render-shopping-list");
var _colorSwithcer = require("./js/color-swithcer");

},{"./js/switch-theme":"8ea4I","./js/extra-block-slider":"iKyTx","./js/modal-window":"bg8pZ","./js/burger-menu":"egJfa","./js/shopping-list":"23YiB","./js/render-shopping-list":"fxQRU","./js/color-swithcer":"65EWk"}],"8ea4I":[function(require,module,exports) {
...
},{"../images/extra-block/saveCh.png":"9Ukbh","../images/extra-block/hope.png":"eQX0G","../images/extra-block/medical.png":"ckzRF","../images/extra-block/razom.png":"5tXwF","../images/extra-block/action.png":"lVbss","../images/extra-block/serhiy.png":"9CUff","../images/extra-block/united.png":"gaOtR","../images/extra-block/sans.png":"44DIK","../images/extra-block/vision.png":"4NR3K","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Ukbh":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "saveCh.7fa8f133.png" + "?" + Date.now();
...
},{}],"eQX0G":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "hope.09fcbd73.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"ckzRF":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "medical.3f709fb0.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"5tXwF":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "razom.15eb9ecf.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"lVbss":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "action.65c5565e.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"9CUff":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "serhiy.9000f9d1.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"gaOtR":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "united.55f83227.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"44DIK":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "sans.81d4d48f.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"4NR3K":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "vision.47c10699.png" + "?" + Date.now();
...
},{"./books-action":"gsCQ3","./shopping-list":"23YiB","./fetch-func":"i4UGa","../images/modal-window-book/icons/amazon_bk.png":"cyF2Z","../images/modal-window-book/icons/open-book_bk.png":"9Z6Jg","../images/modal-window-book/icons/book-shop_bk.png":"6Mxgi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gsCQ3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addBook", ()=>addBook);
...
},{}],"cyF2Z":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "amazon_bk.19b0710c.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"9Z6Jg":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "open-book_bk.58d5cfa3.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"6Mxgi":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "book-shop_bk.782906c8.png" + "?" + Date.now();
...
},{}],"fxQRU":[function(require,module,exports) {
var _shoppingList = require("./shopping-list");
const plug = document.querySelector(".shop_plug");
const div_card_container = document.querySelector(".js-shop_card");
let number_of_books = Object.keys((0, _shoppingList.shopping_info).shopping_list).length;
// addBook();
...
// ----------------------------
markupBookCard((0, _shoppingList.shopping_info).shopping_list);
...
function markupBookCard(data) {
    ...
    keys.forEach((key)=>{
        let { book_image , title , list_name , description , author , amazon , apple_books , bookshop ,  } = data[key];
        if (!book_image.trim()) book_image = require("../images/shoppin-list/no_book.png");
        markup += `
...
function onClickDel(event) {
    ...
    (0, _shoppingList.removeShoppingListBoock)(event.target.dataset.id);
    const cardDel = document.getElementById(`${event.target.dataset.id}`);
    cardDel.remove();
    if (!--number_of_books) {
        plug.style.display = "block";
        localStorage.clear();
        0, _shoppingList.shopping_info;
    }
}

},{"./shopping-list":"23YiB","../images/shoppin-list/no_book.png":"7X0B5","../images/shoppin-list/icons/amazon_black.png":"gRkIs","../images/shoppin-list/icons/amazon_wite.png":"3Bigp","../images/shoppin-list/icons/book_1.png":"3fJEF","../images/shoppin-list/icons/book_2.png":"5plH5"}],"7X0B5":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "no_book.a38f0269.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"gRkIs":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "amazon_black.c6df1914.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"3Bigp":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "amazon_wite.6baf3a93.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"3fJEF":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "book_1.b94ff98a.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"5plH5":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "book_2.e5be150b.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"65EWk":[function(require,module,exports) {
...
},{"/src/images/header/logo-light.png":"iaduy","/src/images/header/logo-dark.png":"9xCP3"}],"iaduy":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "logo-light.0235434a.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"9xCP3":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2hz4U") + "logo-dark.f5a1e6d2.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["kIEhV","dT0E2"], "dT0E2", "parcelRequired7c6")

//# sourceMappingURL=shopping-list.dce11834.js.map
